    ...
    return (
        <div className="mb-4 p-4 bg-white border rounded-md shadow-lg w-auto">
            ...
            <div className=' flex items-center justify-between p-2'>
                <Button onClick={() => handleRemoveField(index,fieldData.id)} color="red" className="p-2 bg-white text-red-700 shadow-md shadow-gray-500 text-2xl"><MdDelete /></Button>
