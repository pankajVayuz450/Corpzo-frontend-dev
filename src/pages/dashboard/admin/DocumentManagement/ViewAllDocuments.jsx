...
const ViewlAllDocuments = () => {
  ...
  useEffect(() => {
    ...
    // dispatch(getFolderDocuments(page, query))
  ...
  return (
    <div className='w-full mt-4'>
      ...
      <HeaderTitle title="Documents" totalCount={totalFolderDocuments} />
...
export default ViewlAllDocuments;
