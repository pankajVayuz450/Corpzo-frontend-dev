...
import { setIsFormCreated } from '@/redux/admin/slices/form';
...
const FormCreationPage = ( ) => {
  ...
  const handleCreateFields = () => {
    ...
    navigate('/dashboard/admin/formManagement/create-page-2', { state: { formDetails  } });
    ...
    <div className="max-w-4xl mx-auto my-10 p-5 shadow-lg rounded-lg bg-white">
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          .unwrap()
          .then((response)=>{
            setFormDetails({id:response.data._id, title:response.data.title
            })
