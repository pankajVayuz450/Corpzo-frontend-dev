...
const ApplicationManagement = () => {
  ...
  const nevigateToform = (applicationId, formId, userId) => {
    ...
    navigate(`/dashboard/admin/add-application/${applicationId}?formId=${formId}&&userId=${userId}`)
  }
    ...
    <div className='w-full'>
      ...
      <div className='flex justify-end items-center w-full mb-4'>
        <div className='flex justify-between gap-5 '>
          ...
          <NavLink to="/dashboard/admin/application-logs" className="bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
            View Logs
          </NavLink>
          <SearchBoxNew />
        </div>
